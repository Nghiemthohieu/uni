...
export default function IntroductionIelts() {
    return (
        <div className="max-w-[1060px] mx-[auto] text-center p-[16px] grid gap-10 bg-white mb-[30px]">
            ...
            <div className="grid gap-3">
                ...
                <TeachingMethods course="ielts3.0"/>
                <TargetCourse course="ielts3.0"/>
            </div>
            <div className="grid gap-3">
                <h4 className="text-[2.135rem] leading-[1.235] font-[600] text-[rgb(211,47,47)] mb-[16px]">Khóa hoc IELTS 3.0 - 5.0+</h4>
                <p className="icon__boil flex justify-center">
                    <span className="material-symbols-outlined" style={{fontSize: '20px'}}>
                        schedule
                    </span>
                ...
                <TeachingMethods course="ielts5.0"/>
                <TargetCourse course="ielts5.0"/>
            </div>
            <div className="grid gap-3">
                <h4 className="text-[2.135rem] leading-[1.235] font-[600] text-[rgb(211,47,47)] mb-[16px]">Khóa hoc IELTS 5.0 - 6.5+</h4>
                <p className="icon__boil flex justify-center">
                    <span className="material-symbols-outlined" style={{fontSize: '20px'}}>
                        schedule
                    </span>
